    ...
    <section id="checkout_layout_block_2">
        ...
        <form>
            <div class="fieldset">
                ...
                <section id="checkout_login_user">
                    <label>Password</label>
                    <div class="input-box">
                        <input type="password">
                    </div>
                    <div id="checkout_login_button" class="buttons-set">
                        <button type="button" onclick="window.location.href = '/checkout_step_1_logged_in.php'"><i
                                class="fa fa-refresh fa-spin"></i><span>Login</span></button>
                    </div><!-- end button set -->
                    <p id="checkout_forgot_password_link"><a href="/customer_forgot_password.php">Forgot Your
                            Password?</a></p>
                    <p id="checkout_no_login_link"><a href="#">Checkout as Guest</a></p>
                </section><!-- end checkout login user -->
            ...
            <div id="shipping_address_form" class="form-list active">
                ...
                <div class="buttons-set">
                    <button type="button" onclick="window.location.href = '/checkout_step_2.php'"><i
                            class="fa fa-refresh fa-spin"></i><span>Continue</span></button>
                    <p class="back-link">
                        <a href="/checkout_cart.php">Back</a>
                    </p>
                </div><!-- end buttons set -->
            </div><!-- end form list -->
