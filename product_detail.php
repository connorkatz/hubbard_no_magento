...
<?php include 'includes/scroll_arrow.php' ?>
    ...
    <div id="prod_content_container">
        ...
        <section id="testimonial_callouts">
            <ul>
                <li>
                    <blockquote>
                        <p>These are amazing shoes. Perfect fit and look great too. When shoes feel like no shoes or slippers, then the ultimate is achieved!</p>
                        <footer>Brian Wells</footer>
                    </blockquote>
                </li>
                <li>
                    <blockquote>
                        <p>My husband absolutely loves them and says they are the most comfortable shoes he has ever owned. That is saying a lot, because he has long had trouble with his feet.</p>
                        <footer>Roberta Almeza</footer>
                    </blockquote>
                </li>
                <li>
                    <blockquote>
                        <p>I've now rugged road tested my Hubbards and have the evidence to crown them as most comfortable shoes on the planet. I've worn them for eight 14-hour straight days at three different conferences in three different cities, my feet are as comfortable in these shoes on the last day as they were in the first few minutes I put them on.</p>
                        <footer>David Portsmith</footer>
                    </blockquote>
                </li>
            </ul>
            <span>More Reviews</span>
        </section><!-- end testimonial callouts -->
