...
<?php include 'includes/scroll_arrow.php' ?>
    <section id="homepage_hero">
        <div class="full_width_slideshow">
            <div class="full_width_slideshow_inner">
                <ul>
                    <li class="item_1">
                        <div class="homepage slide_item">
                            <div class="homepage slide_content">
                                <a href="#"></a>
                            </div><!-- end homepage slide content -->
                        </div><!-- end homepage slide -->
                    </li>
                    <li class="item_2">
                        <div class="homepage slide_item">
                            <div class="homepage slide_content">
                ...
                <div class="full_width_slide_arrow prev"></div>
                <div id="homepage_hero_slideshow_nav" class="slideshow_nav_pages"></div>
                <div class="full_width_slide_arrow next"></div>
            </div><!-- end full width slideshow inner -->
        </div><!-- end full width slideshow -->
    </section><!-- end homepage hero slideshow -->
    ...
    <section id="homepage_review_callouts">
        <div id="homepage_review_callouts_inner">
            <div id="homepage_review_callout_stars">
            ...
            <ul>
                ...
                <li>
                    <blockquote>
                        ...
                        <footer>Roberta Almeza <span>&mdash; Acmeville, CA</span></footer>
                    </blockquote>
                </li>
                <li>
                    <blockquote>
            ...
            <div class="homepage_review_nav_arrow prev"></div>
            <div id="homepage_review_nav_pages"></div>
            <div class="homepage_review_nav_arrow next"></div>
