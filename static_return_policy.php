<?php include 'includes/header.php'; ?>
    ...
    <section id="basic_static_content">
        ...
        <p>To return an item to us, fill out a <a href="/static_return_form.php">Return Form</a>, for a prepaid shipping label and follow the
        ...
        <ul>
            ...
            <li><a href="/static_return_form.php">Print a label</a>, slap it on the carton (not the shoebox, please).
            </li>
        ...
        <p>Just place a new order and return your original item using the <a href="/static_return_form.php">Return
